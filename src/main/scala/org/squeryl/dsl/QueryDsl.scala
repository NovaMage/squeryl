...
//      queryToIterable(view2QueryAll(t))
  ...
  implicit val instantToZonedDateTimeComparisonEvidence  = new CanCompare[TOptionInstant, TOptionZonedDateTime]
  ...
  implicit val offsetDateTimeToZonedComparisonEvidence  = new CanCompare[TOptionOffsetDateTime, TOptionZonedDateTime]
  implicit val zonedDateTimeComparisonEvidence  = new CanCompare[TOptionZonedDateTime, TOptionZonedDateTime]
  implicit val zonedDateTimeToInstantComparisonEvidence  = new CanCompare[TOptionZonedDateTime, TOptionInstant]
  implicit val zonedDateTimeToOffsetComparisonEvidence  = new CanCompare[TOptionZonedDateTime, TOptionOffsetDateTime]
